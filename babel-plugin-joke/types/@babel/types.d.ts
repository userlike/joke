...
// See babel-types/scripts/generators/typescript.js for script used.
// Due to a bug in type generator, the following changes are manually made:

/**
 * Identifier.name: any -> string
 */
